...
if edadid >=18:
    ...
    while activar:
        ...
        opcion = input("Elega cual de las opciones quieres elegir: ")
        ...
        if opcion =="1":
            ...
            eliminar = input ("¿Que producto deseas eliminar de tu carrito? " )
            ...
            observar = input("Que producto deseas buscar: " )
